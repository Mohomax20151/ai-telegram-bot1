...
async def start_handler(message: Message, state: FSMContext):
    ...
    if not data.get("intro_done"):
        ...
        await message.answer(
            ...
            "🔐 <b>Набор идет до 1000 постоянных пользователей</b>, для которых функции бота останутся бесплатными, в свою очередь как для новых пользователей в августе, либо же непоястоянных, введется система оплаты\n"
            "📉 <b>Прибыль сейчас</b> — стабильная и постоянная при распределении банка флэтом, цель: рост процента побед;к концу месяца по тенденции процент побед будет составлять 83%, из миллионов котировок будут выбираться именно те, которые будут прибыльными\n\n"

            "<b>⚙️ Что происходит сейчас:</b>\n"
            "🤖 AI:\n"
            "— 📚 Сканирует сотни источников\n"
            "— 📊 Анализирует тренды, коэффициенты\n"
            "— 🧠 Использует нейросети для value-прогнозов и развивается на ошибках и качественных нововведениях, по каждому матчу производится многоступенчатая аналитика\n\n"

            "<b>🚀 Что планируется в будущем:</b>\n"
            "📈 Повышение точности\n"
            "📊 Интерактивная аналитика\n"
            "🧩 Расширение функционала внутри бота (появится долгосрочная прозрачная статистика, появятся live-ставки для постоянных пользователей и многое другое"
        )
